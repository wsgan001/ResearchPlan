...
\newpage
	...
	\begin{minipage}{.8\textwidth}
		\centering
		%		\vspace{2.5em}
		\includegraphics[width=0.8\textwidth,keepaspectratio]{figures/5.PreliminaryW/scope_9}
		%		\vspace{2em}
	...
	\begin{minipage}{.8\textwidth}
		\centering
		\includegraphics[width=0.8\textwidth,keepaspectratio]{figures/5.PreliminaryW/scope_10}
		%		\vspace{2em}
...
\begin{figure}[h!]
	\centering
%	\vspace{-1em}
	\includegraphics[width=0.85\textwidth,keepaspectratio]{figures/5.PreliminaryW/omnetpp+ns3}
