...
\begin{figure}[h!]
	...
	\begin{minipage}{.6\textwidth}
		...
		%		\vspace{0.5em}
		\captionof{figure}{Train internal power circuit of a DC supply system. Adapted from \cite{steimel2008}.}
...
\begin{figure}[h!]
	...
	\begin{minipage}{.6\textwidth}
		...
		%		\vspace{0.5em}
		\captionof{figure}{Train internal power circuit of a AC supply system. Adapted from \cite{steimel2008}.}
